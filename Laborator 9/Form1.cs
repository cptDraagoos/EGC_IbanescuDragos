...
namespace Laborator_9
{
    public partial class Form1 : Form {
        private static string locatieFisierSolutie = Directory.GetParent(Directory.GetCurrentDirectory()).Parent.Parent.FullName;
        ...
        private string fileVertex = locatieFisierSolutie + "\\Laborator 9\\vertexList.txt";
        private string fileQList = locatieFisierSolutie + "\\Laborator 9\\quadsVertexList.txt";
        private string fileTList = locatieFisierSolutie + "\\Laborator 9\\trianglesVertexList.txt";
        ...
        private void LoadTextures() {
            ...
            LoadTexture(textures[0], locatieFisierSolutie + "\\Laborator 9\\Resources\\brickTexture.jpg");
            LoadTexture(textures[1], locatieFisierSolutie + "\\Laborator 9\\Resources\\OpenGLTexture.png");
        }
        ...
        private void btnReset_3_Click(object sender, EventArgs e)
        {
            resetTexCubes();
        }
        ...
        private void DeseneazaPiramida()
        {
            ...
            for (int i = 0; i < arrTrianglesPiramida.GetLength(0); i++)
            {
                GL.TexCoord2(0.5, 0.0); 
                GL.Vertex3(arrVertexPiramida[arrTrianglesPiramida[i, 0], 0], arrVertexPiramida[arrTrianglesPiramida[i, 0], 1], arrVertexPiramida[arrTrianglesPiramida[i, 0], 2]);

                GL.TexCoord2(0.0, 1.0); 
                GL.Vertex3(arrVertexPiramida[arrTrianglesPiramida[i, 1], 0], arrVertexPiramida[arrTrianglesPiramida[i, 1], 1], arrVertexPiramida[arrTrianglesPiramida[i, 1], 2]);

                GL.TexCoord2(1.0, 1.0); 
                GL.Vertex3(arrVertexPiramida[arrTrianglesPiramida[i, 2], 0], arrVertexPiramida[arrTrianglesPiramida[i, 2], 1], arrVertexPiramida[arrTrianglesPiramida[i, 2], 2]);
            }
